...
import { tryNormalizeTokens, DEFAULT_TOKENS, type ThemeTokens } from '@/lib/tokens';
...
export function ThemeControls({ theme }: ThemeControlsProps) {
...
function TokenTable({ tokens }: { tokens: ThemeTokens }) {
  return (
